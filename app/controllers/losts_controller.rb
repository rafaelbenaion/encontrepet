class LostsController < ApplicationController
  ...
  # GET /losts/1.json
  def show
         @meta = { title: 'PROCURA-SE ! '+@lost.name.downcase.capitalize+' em '+@lost.city.downcase.capitalize+'.', description: @lost.about+'. Por Encontrepet.com', image: 'http://encontrepet.com'+@lost.photo.url, type: 'article' }
  end
