...
def filtering_params(params)
  ...
  # GET /posts/1.json
  def show
     @meta = { title: 'Meu nome é '+@post.name.downcase.capitalize+', me adote!', description: @post.about+'. Por Encontrepet.com', image: 'http://encontrepet.com'+@post.image.url(:thumb), type: 'article' }
  end
